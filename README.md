...
The foundational inspiration for this project stems from the methodology established by Keith Carlson, Allen Riddell, and Daniel Rockmore in their 2018 paper, *Evaluating prose style transfer with the Bible*. Their research analyzed over 30 English Bible versions using the [MOSES Statistical Machine Translation Toolkit](https://github.com "moses-smt/mosesdecoder") to successfully execute unsupervised prose style transfer across different historical and stylistic vernaculars. 
